...
const AIChat = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <div className="bg-quant-dark border-b border-quant-gold px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <ChatBubbleLeftRightIcon className="h-6 w-6 text-quant-green mr-3" />
            <div>
              <h1 className="text-2xl font-extrabold text-quant-gold font-mono drop-shadow-lg">QuantaVista AI Financial Advisor</h1>
              <p className="text-quant-green font-mono">Get personalized financial insights and advice</p>
            </div>
          </div>
          <button
            onClick={clearChat}
            className="btn-quant flex items-center"
          >
      ...
      {/* Chat Container */}
      <div className="flex-1 overflow-y-auto p-4 bg-quant-dark">
        {/* Main Chat Area */}
